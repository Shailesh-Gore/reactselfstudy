  ...
  return (
    <div className="head-container">
      <div className="logo-container">
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ9cO786EWLpmRJZWAesQWq5azxnp19hVq0aQ&usqp=CAU" />
      </div>
...
const RestaurantcardsComponent = (props) => {
  const { resData } = props;
  ...
  return (
    <div className="res-card">
      <div className="res-card-container">
        ...
        <h3>{resData.sla.deliveryTime} min</h3>
